...
const penaltyWeightPresets = [
  ...
  { drawWeightValue: 2, label: 'Minimise DUPR differences for the match',  partnerDuprGapWeight: 10,  partnerFrequencyWeight: 100,  opponentDuprGapWeight: 100,  opponentFrequencyWeight: 10  }
];
