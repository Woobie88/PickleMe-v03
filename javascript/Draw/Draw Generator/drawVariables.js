...
const penaltyWeightPresets = [
  { drawWeightValue: 0, label: 'Maximise partner & opponent rotation', partnerDuprGapWeight: 10, partnerFrequencyWeight: 100, partnerDuprDelta: 0.5,  
    opponentDuprGapWeight: 10,  opponentFrequencyWeight: 100, opponentDuprDelta: 0.5, opponentMinExpScore: 5  },
  ...
  { drawWeightValue: 2, label: 'Minimise DUPR differences for the match',  partnerDuprGapWeight: 100,  partnerFrequencyWeight: 25, partnerDuprDelta: 0.4,
    opponentDuprGapWeight: 100,  opponentFrequencyWeight: 10, opponentDuprDelta: 0.2, opponentMinExpScore: 8  }
];
