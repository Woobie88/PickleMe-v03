...
const penaltyWeightPresets = [
  ...
  { drawWeightValue: 2, label: 'Minimise DUPR differences for the match',  partnerDuprGapWeight: 100,  partnerFrequencyWeight: 80,  
    opponentDuprGapWeight: 100,  opponentFrequencyWeight: 20  }
];
